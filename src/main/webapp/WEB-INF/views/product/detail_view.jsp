	...
	<table class="table_view">
		...
		<table align="center" style="margin-top: 100px;" cellpadding="0" cellspacing="0">
	 	...
	 	<table align="center" height="100" width="1000">
	 		...
	 		<tr>
	 			<td align="center" ><img style="margin-top: 100px; width:80%;" src="resources/contentImage/${vo.content_img }"></td>
	 		</tr>
	 		<tr>
	 			<td align="center"><br><pre>${vo.content }</pre></td>
	 		</tr>
	 	</table>
